...
# Chatbot CHELSEA: CHat Emotion Logic SEnse Automator (0.08) (BETA)
...
while userMessage != "//exit":
	...
	meaning_match = re.search(r"(what (do you|does that) mean|(can you|(do you|can you) care to) clarify|I('m| am) confused|I do( not|n't) (understand|get( it)?)( what you mean| what (that|this) means)?)\?*$", userMessage)
	if (meaning_match):
