...
# Chatbot CHELSEA: CHat Emotion Logic SEnse Automator (0.20) (BETA)
...
# Version 0.20 (Now works experimentally with bigrams using a topic word as a starter to 'imagine' a response): 11-08-2024
...
class chelsea:
	...
	def input_bigram_dict(self):
		with open("bigramDictionary.json", 'r') as bigram_dictionary_file:
